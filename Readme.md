...
Количество нейронов в каждом слое может варьироваться.
...
Таким образом в дальнейшем мы рассматриваем сеть с полностью связанными соседними слоями и с прямым распространением сигнала.


***Скрытые слои***

Количество скрытых слоёв может варьироваться.
